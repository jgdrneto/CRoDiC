...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        LoaderCallbacks<List<Evento>> callback = MainActivity.this;
     ...
     */
    @Override
    public Loader<List<Evento>> onCreateLoader(int id, final Bundle loaderArgs) {

            return new AsyncTaskLoader<List<Evento>>(this) {
             ...
             */
            @Override
            public List<Evento> loadInBackground() {
             ...
             */
            public void deliverResult(List<Evento> data) {
                roteiro = data;
     ...
     */
    @Override
    public void onLoadFinished(Loader<List<Evento>> loader, List<Evento> data) {
     ...
     */
    @Override
    public void onLoaderReset(Loader<List<Evento>> loader) {
        /*
    ...
    private void invalidateData() {
        mForecastAdapter.setWeatherData(new ArrayList<Evento>());
    }
